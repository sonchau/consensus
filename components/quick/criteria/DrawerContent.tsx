...
const DrawerContent = () => {
    return (
        <div className="drawer-container">
            ...
            <ul>
                <li>Your objectives should be as specific as possible, particularly if they involve distance, cost or any other scale-able measure. For example, rather than having an objective that says "To have a clinic close to the primary school", you would be better with:</li>
            </ul>
            ...
            <ul>
                <li>Be careful that your objectives don't double up. If they do, you are effectively doubling the weight of this issue. For example, the following two objectives are really the same:</li>
            </ul>
            ...
            <ul>
                <li>When adding a weight to your objectives, you're really saying "How important is this objective, relative to the others?" If it's a deal breaker, you should give it a high weighting. If it's a minor nice-to-have kind of outcome then it should have a low weighting.</li>
                <li>Remember that you cannot change these weightings, so make sure you are happy with them before you continue</li>
            </ul>
